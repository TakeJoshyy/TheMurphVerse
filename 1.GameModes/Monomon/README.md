...
### Monomon is the easier means of playing [Murphmon](https://github.com/TakeJoshyy/TheMurphVerse/blob/main/1.GameModes/Murphmon/README.md). Monomon does NOT require the mid game pivot in Safari Zone, Bug Catching Contest, etc. Additionally, Gym Leaders only have 3 additional Pokemon and opponents' held items are removed from much of the game.
